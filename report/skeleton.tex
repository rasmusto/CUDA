...
\begin{multicols}{2}
  ...
  \begin{enumerate}
    \item Gettimeofday: The \mint{c}|gettimeofday()| function shall obtain the current time, expressed as seconds and microseconds since the Epoch, and store it in the timeval structure pointed to by tv.
