...
\begin{flushleft}
  \begin{thebibliography}{99}
    ...
    \bibitem{bibwolfe}``Jacobi Relaxation''
      Dr. Michael Wolfe. The Portland Group, Inc. $<$http://www.pgroup.com/$>$
    %\bibitem{bib:nvidia}``Nvidia CUDA User Guide''
    %\bibitem{bib:wiki page for XEON}
    %\bibitem{papers in class}%at least the microbenchmarks one
  \end{thebibliography}
\end{flushleft}
